...
var productListData = [{
    'id': 1,
    "productImg": "/static/images/products/img-10.png",
    ...
    'id': 2,
    "productImg": "/static/images/products/img-15.png",
    ...
    'id': 3,
    "productImg": "/static/images/products/img-1.png",
    ...
    'id': 4,
    "productImg": "/static/images/products/img-7.png",
    ...
    'id': 5,
    "productImg": "/static/images/products/img-4.png",
    ...
    'id': 6,
    "productImg": "/static/images/products/img-5.png",
    ...
    'id': 7,
    "productImg": "/static/images/products/img-6.png",
    ...
    'id': 8,
    "productImg": "/static/images/products/img-9.png",
    "productTitle": "Lace-Up Casual Shoes For Men",
    "category": "Kids",
    "price": "229.00",
    "discount": "15%",
    ...
    'id': 10,
    "productImg": "/static/images/products/img-12.png",
    ...
    'id': 11,
    "productImg": "/static/images/products/img-3.png",
    ...
    'id': 12,
    "productImg": "/static/images/products/img-2.png",
                ...
                data: (function (row) {
                    ...
                    return gridjs.html('<div class="d-flex align-items-center">\
                            ...
                            <div class="flex-grow-1">\
                                <h6 class="mb-1"><a href="/product/product_create" class="d-block text-reset">'+ row.productTitle + '</a></h6>\
                ...
                data: (function (row) {
                    return gridjs.html('<div class="text-center dropdown">\
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">\
                            <li>\
                                <a class="dropdown-item" onClick="editProductList('+ row.id + ')" href="/product/product_create"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a>\
                            </li>\
                            <li>\
