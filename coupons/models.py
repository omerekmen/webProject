...
class SpecialDiscount(models.Model):
    ...
    DISCOUNT_TYPE_CHOICES = [("percentage", "Yüzde"), ("amount", "Tutar")]
    discountType = models.CharField(max_length=255, verbose_name="İndirim Tipi", choices=DISCOUNT_TYPE_CHOICES, default="percentage")
    ...
    created_at = models.DateTimeField(verbose_name="İndirim Oluşturulma Tarihi", auto_now_add=True)
    updated_at = models.DateTimeField(verbose_name="İndirim Güncellenme Tarihi", auto_now=True)
